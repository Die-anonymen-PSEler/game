...
public abstract class Vertex {
	...
	public boolean equals(Vertex v) {
		...
		if(this.getnext() != null ^ v.getnext() != null) {
			return false;
		} else if(this.getnext() != null) { //in case both are not null, need to compare them.
			if (!this.getnext().equals(v.getnext())) { //if they do not equal we can return false
				return false;
			}
		}
		...
		if(this.getfamily() != null ^ v.getfamily() != null) {
			return false;
		} else if(this.getfamily() != null) { //in case both are not null, need to compare them.
			if (!this.getfamily().equals(v.getfamily())) { //if they do not equal we can return false
				return false;
			}
		}
