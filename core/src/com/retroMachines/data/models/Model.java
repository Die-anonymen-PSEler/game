...
/**
 * This class is part of the model of RetroMachines. This class is abstract and
 * needs to be implemented by all other model classes. It retrieves a copy of
 * the database within it's constructor so children classes can execute their
 * implemented methods.
 * 
 * @author RetroFactory
 */
public abstract class Model {
	...
	/**
	 * This method saves the model and all it's attributes to the persistent
	 * background storage.
	 */
