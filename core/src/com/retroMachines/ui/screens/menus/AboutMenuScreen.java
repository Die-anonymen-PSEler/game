...
public class AboutMenuScreen extends MenuScreen {
	...
	protected void initialize() {
		...
		scrollTable.add(gameInfoText3).width(textWidth).padTop(screenHeight / DEFAULTPADDING).padBottom(screenHeight / DEFAULTPADDING).row();
		scrollTable.add(gameInfoText4).width(textWidth).padTop(screenHeight / DEFAULTPADDING).padBottom(screenHeight / DEFAULTPADDING).row();
		scrollTable.add(gameInfoText5).width(textWidth).padTop(screenHeight / DEFAULTPADDING).padBottom(screenHeight / DEFAULTPADDING).row();
		scrollTable.add(gameInfoText6).width(textWidth).padTop(screenHeight / DEFAULTPADDING).padBottom(screenHeight / DEFAULTPADDING).row();
		scrollTable.add(aboutText).width(textWidth).padTop(screenHeight / DEFAULTPADDING).padBottom(screenHeight / DEFAULTPADDING).row();
